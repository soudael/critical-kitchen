...
No public builds are available at this time.

Critical Kitchen is currently in early development. <br>
Public playtests and downloadable builds will be released in the future.

## 📜 License

> [!IMPORTANT]
> Critical Kitchen is a proprietary project. <br>
> All rights reserved. <br>
> See [LICENSE.md](LICENSE.md) for full terms.

## 🐞 Feedback & Bugs

Gameplay feedback and bug reports are welcome. <br>
If you encounter bugs or want to leave feedback, please use the GitHub Issues section or contact the author's email. <br>
For security-related issues or project policies,
please refer to [SECURITY.md](SECURITY.md) and [POLICY.md](POLICY.md).
